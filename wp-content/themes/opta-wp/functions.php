...
if (!function_exists('opta_theme_setup')) {
    ...
    function opta_theme_setup() {
        ...
        add_action('admin_enqueue_scripts', 'opta_my_admin_scripts');
...
if (!function_exists('opta_my_admin_scripts')) {

    function opta_my_admin_scripts() {
        wp_enqueue_script('opta-my-admin-js', get_template_directory_uri() . '/admin/js/admin.js', array('jquery'));
    }
...
if (!function_exists('opta_search_form')) {
	...
	<label>		
	<input autocomplete="off" type="search" class="search-field" placeholder="' . esc_html__('Search', 'opta-wp') . '" value="" name="s" title="' . esc_html__('Search for:', 'opta-wp') . '" /> 
</label>    
</form>';
 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Opta Wp for publication on ThemeForest
...
// This is an example of how to include a plugin from an arbitrary external source in your theme.
            ...
            array(
                ...
                'source' => 'http://demo.cocobasic.com/plugins/opta-wp/cocobasic-shortcode-1.1.zip', // The plugin source.
